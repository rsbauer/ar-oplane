// from: https://gist.github.com/raypendergraph/0d053f2667313c16dcea9e961a533d06
import CoreLocation
...
extension CLLocationCoordinate2D {
	...
	- Remark: If you are using these coordinates to create a boolean based query you will need to take special note to
	check for the hemisphere of the corners.
	
	- Remark: Please email me at ray.pendergraph@gmx.com if you find issues with this implementation.
	
	- parameters:
	- distance: (meters) The radius of an inscribed circle on the desired bounding box centered on this coordinate.
